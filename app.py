...
def postRejoindre():
	...
	if joueur == []:
		...
		sqlMap_Item = (""" INSERT INTO Map_Item(mit_type, mit_influence, mit_longitude, mit_lattitude, mit_pla_name, mit_map_id) VALUES('stand' ,10 ,{1} ,{2} ,'{3}', 0);""".format(longitude, latitude ,name))
