...
def getMapPlayer():
	...
	region = ({"region":{"center": coordinate}, {"span":coordinate_span}})
	...
	Map = {"region" : region, "ranking" : rank, "itemsByPlayer" : itemsByPlayer, "playerInfo",playerInfo, "drinksByPlayer":drinksByPlayer}
	print(Map)
	db.close()
